...
const copyrightIcon = document.querySelector("[data-copyright]");
copyrightIcon.insertAdjacentText("afterend", " " + yearText);
...
document.querySelectorAll(".copy-btn").forEach(function (btn) {
  btn.addEventListener("click", function () {
    ...
    const address = card.querySelector(".address-text").textContent.trim();
